...
namespace Thrive.src.Domain
{
	public class SoilProperties
	{
		...
		public SoilProperties(Random rand, int propertyCount, int x, int y, Formulas.SoilInitializationFormulas appliedFormula)
		{
		...
		public void AddCrop(string cid, BaseCropData cData, int soilPropertyCount){
			CropHere = new GrowingCropStats(cid, cData.StarterHealthStats, soilPropertyCount);
		}
